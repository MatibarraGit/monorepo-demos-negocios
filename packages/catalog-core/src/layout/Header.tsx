...
export function Header({ searchTerm, onSearchChange, siteName, navLinks, contact }: HeaderProps) {
      ...
      <div className="content-wrapper flex items-center gap-3 py-3 lg:gap-6">
        <a href="#top" className="flex min-w-0 shrink-0 w-fit items-center gap-2">
          <Image
            ...
            height={40}
            priority
            className="bg-primary-foreground/95 size-10 shrink-0 rounded-full p-px"
          />
        </a>
